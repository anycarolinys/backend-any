    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('AFM06', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='AFM06', to='circunstancia.circunstancia')),
                ('consulta', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='consulta', to='consulta.consulta')),
            ],
        ),
    ]
